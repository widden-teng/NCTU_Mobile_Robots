...
double Kp_R=1.6, Ki_R=1.3, Kd_R=0;
double Kp_L=1.6, Ki_L=1, Kd_L=0;
//double Kp_R=0.8, Ki_R=0.9, Kd_R=0;
//double Kp_L=1.2, Ki_L=1, Kd_L=0;
//double Kp_R=5, Ki_R=0.7, Kd_R=0;
//double Kp_L=5, Ki_L=0.7, Kd_L=0;  
...
//    pwmL = 100;
    ...
    if(resultR && resultL){
//      val_outputL = val_outputL*1.133*1.33; //revised
      val_outputL = val_outputL;
      val_outputR = val_outputR; //revised
      MoveMotor();
      abs_pulseL = 0;
...
//    LSpeed_msg.data = (durationL*0.01064)*25;
    RSpeed_msg.data = (durationR*0.01064)*25*1.33; //revised
    LSpeed_msg.data = (durationL*0.01064)*25;
